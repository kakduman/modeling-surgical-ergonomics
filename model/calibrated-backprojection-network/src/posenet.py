...
def train(train_image_path, # path to 3 images concat'ed together on Horizontal axis with indices: Left, Middle, Right
          train_depth_path,
    ...
    '''
    # Read paths for training # text file: with file paths to each modality
    ...
    assert len(train_depth_paths) == n_train_sample
    ...
    train_dataloader = torch.utils.data.DataLoader(
        datasets.PoseNetTrainingDataset(
    ...
    # log("params: " + str(parameters_pose_model), log_path)
    ...
    # for epoch in range(1, 200):
        ...
        for inputs in train_dataloader:
            ...
            image0, image1, image2, depth0, depth1, depth2, intrinsics0, intrinsics1, intrinsics2 = inputs

            # Validity map is where sparse depth is available
            validity_map_depth0 = torch.where(
                depth0 > 0,
                torch.ones_like(depth0),
                depth0)
            ...
            [image0, image1, image2], \
                ...
                [validity_map_depth0] = train_transforms.transform(
                    images_arr=[image0, image1, image2],
                    range_maps_arr=[depth0, depth1, depth2],
                    validity_maps_arr=[validity_map_depth0],
                    random_transform_probability=0)
            ...
            if (train_step % n_summary) == 0:
                ...
                log('summary to tensorboard', log_path)
